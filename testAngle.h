...
private:
   ...
   void isLeft_right()
    {  // setup
       Angle a;
       a.radians = M_PI / 6.0; // 330 degrees
       bool isItLeft = true;
       // exercise
       isItLeft = a.isLeft();
       // verify
       assertEquals(isItLeft, false);
       assertEquals(a.radians, M_PI / 6.0);
    }  // teardown
