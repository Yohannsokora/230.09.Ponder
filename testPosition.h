...
private:
   ...
   void setPixelsX_zoom()
   {
      ...
      Position pos(999.9, 888.8);
      pos.setPixelsX(123.4);
      assertEquals(pos.getMetersX(), 1.234);
      Position::metersFromPixels = metersFromPixels;
   }
   ...
   void setPixelsY_zoom()
   {
      ...
      Position pos(999.9, 888.8);
      pos.setPixelsY(123.4);
      assertEquals(pos.getMetersY(), 1.234);
      Position::metersFromPixels = metersFromPixels;
   }
   ...
   {
      Position pos(4500.0, 2500.0);
      double newX = pos.addPixelsX(3);
      assertEquals(newX, 4503.0);
   }
   ...
   void addPixelsX_zoom()
   {
      ...
      pos.setZoom(50.0);
      double newX = pos.addPixelsX(3);
      assertEquals(newX, 4500.06);  // 4500.0 + 3/50.0
   }
   ...
   {
      Position pos(4500.0, 2500.0);
      double newY = pos.addPixelsY(3);
      assertEquals(newY, 2503.0);
   }
   ...
   void addPixelsY_zoom()
   {
      ...
      pos.setZoom(50.0);
      double newY = pos.addPixelsY(3);
      assertEquals(newY, 2500.06);  // 2500.0 + 3/50.0
   }
